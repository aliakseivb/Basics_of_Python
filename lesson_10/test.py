...
class Textil:
    ...
    def get_sq_full(self):
        return f'Площадь общая - {(self.width / 6.5 + 0.5) + (self.height * 2 + 0.3)}'
...
# print(j1)
# print(j2)
print(c1.get_sq_full)
# print(j1.get_sq_full)
# print(j1.get_square_c())
# print(j1.get_square_j())
# print(j2.get_square_j())